...
import { ArrowUp10, BarChart3, Bell, Car, CarFront, Cog, Files, Home, OctagonAlert, Settings, Wrench } from "lucide-react";
            ...
            <div className="flex h-full max-h-screen flex-col gap-2">
                ...
                <div className="flex-1">
                    <nav className="grid items-start px-2 text-sm font-medium lg:px-4">
                        <span className="block px-3 py-2 text-xs font-semibold text-muted-foreground">Dashboard</span>
                        <Link
                            href="/"
                        ...
                        <span className="block px-3 py-2 text-xs font-semibold text-muted-foreground mt-2">My Vehicle</span>
                        <Link
                            href="/service"
                            className={cn("flex items-center gap-3 rounded-lg px-3 py-2 transition-all hover:text-primary", {
